        ...
        <div>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm flex items-center'>
              ...
              wannaoutbound@gmail.com
            </p>
          </div>
        </div>
      </div>
      <hr className='w-full my-6 border border-tertiary' />
      <div className='text-center text-xs text-white/70'>
        © {new Date().getFullYear()} Wanna Outbound. All rights reserved.
      </div>
    </footer>
  )
}
